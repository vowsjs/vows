...
//
// Exception raised when a test doesn't pass
//
...
//
// Function called when a test failed
//
        ...
        try {
            ...
            if (e.name.match(/AssertionError/)) {
                ...
                exception = '  ~ ' + stylize("expected " +
                    stylize(inspect(e.expected), 'bold') + ", got " +
                    stylize(inspect(e.actual), 'bold') + "\n", 'yellow');
                broken++;
