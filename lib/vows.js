...
var sys = require('sys'),
    ...
    vows = exports,
    prefix = __dirname + '/vows/',
    
    // Include stylize and console
    stylize = require(prefix + '/console').stylize,
    console = require(prefix + '/console');
    

// Options
vows.options = {
    Emitter: events.EventEmitter,
    reporter: require(prefix + '/reporters/dot-matrix'),
    matcher: /.*/,
...
vows.inspect = console.inspect;
vows.prepare = require(prefix + '/extras').prepare;
vows.tryEnd = require(prefix + '/suite').tryEnd;
